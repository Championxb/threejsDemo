...
function init() {
    ...
    const barData = [
        ...
        { value: 333, total: 500, colorStart: 0x00aaff, colorEnd: 0x87cefa, label: '柱4' },
    ];
    ...
    const planeMaterial = new THREE.MeshPhongMaterial({ color: 0x011D487A, transparent: true, opacity: 0.2 });
