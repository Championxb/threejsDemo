...
let scene, camera, renderer, ring1, ring2;
...
const init = () => {
    ...
    // 创建两个环形柱体段
    ring1 = createRingSegment(1, 2, 2, 0x1688f4, 0, Math.PI * 1.2);
    ring1.position.y = 10.25;
    ring1.rotateX(Math.PI / 8);
    scene.add(ring1);

    ring2 = createRingSegment(1, 2, 1.5, 0xf47416, Math.PI * 1.2, Math.PI * 2);
    ring2.position.y = 10;
